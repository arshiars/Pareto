export default function ConventionalPage({ onSelect, onBack }) {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-8 py-16">
        <button
          onClick={onBack}
          className="absolute top-24 left-8 inline-flex items-center gap-1.5 text-sm text-[#777777] hover:text-primary transition-colors"
        >
        ...
        <div className="grid grid-cols-1 gap-4 w-full max-w-sm">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-[#999999] text-xs mt-0.5">IPP</p>
            </div>
